(self.AMP = self.AMP || []).push({
  ...
  f: function (t, n) {
    !(function () {
      ...
      var d = Array.isArray;
      function m(t, n) {
        for (var i = 0; i < t.length; i++) if (n(t[i], i, t)) return i;
        return -1;
      }
      function p(t, n) {
      ...
      function it(t) {
        return (
          ...
          (function (t, n) {
            ...
            ? tt.userForEmbed || (tt.userForEmbed = rt())
            : tt.user
        );
      }
      function rt(t) {
      ...
      function bt(t, n) {
        ...
        return i
          ? i.promise
            ? i.promise
            : (pt(t, n), (i.promise = Promise.resolve(i.obj)))
          : null;
      }
      function Et(t) {
      ...
      var Ft = (function () {
          ...
          return (
            (n.push = function (t) {
              this.nTt &&
                this.nTt.time < t.time &&
                (this.tTt += Ht(this.nTt, t.time)),
                (this.nTt = t);
            }),
        ...
        Gt = (function () {
          function t(t) {
            (this.ampdoc = t),
              ...
              (this.vTt = !1),
              (this.dTt = new Ft()),
              (this.eo = Ct(this.ampdoc)),
              this.ampdoc.whenFirstVisible().then(this.wh.bind(this));
          }
          var n = t.prototype;
          return (
            (n.wh = function () {
              (this.Hh = Date.now()), this.uTt(), this.mTt();
            }),
            (n.pTt = function () {
              var t = Date.now() - this.Hh;
              return t > 0 ? t : 0;
            }),
            (n.rTt = function () {
            ...
            (n.mTt = function () {
              this.TTt(this.ampdoc.getRootNode(), Vt, this.eTt),
                ...
                this.eo.onScroll(this.eTt);
            }),
            (n.TTt = function (t, n, i) {
              for (var r = 0; r < n.length; r++) this.fTt.push(Lt(t, n[r], i));
            }),
            (n.uTt = function () {
              this.lTt || ((this.lTt = !0), (this.vTt = !1), this.bTt(jt));
            }),
            (n.oTt = function () {
              this.vTt ||
                ((this.vTt = !0), (this.lTt = !1), this.bTt("inactive"));
            }),
            (n.bTt = function (t) {
              var n = this.pTt(),
                i = Math.floor(n / 1e3),
                r = 1e3 - (n % 1e3);
              setTimeout(this.iTt, r), this.dTt.push({ type: t, time: i });
            }),
            (n.hTt = function () {
            ...
            (n.getIncrementalEngagedTime = function (t) {
              ...
              if (!w(this.cTt, t))
                return (
                  n && (this.cTt[t] = this.getTotalEngagedTime()),
                  this.getTotalEngagedTime()
                );
              var i = this.cTt[t];
              return !1 === n
                ? this.getTotalEngagedTime() - i
                : ((this.cTt[t] = this.getTotalEngagedTime()), this.cTt[t] - i);
            }),
            t
          );
        })();
      ...
      function Wt(t) {
        for (var n = 1; n < arguments.length; n++) {
          ...
          n % 2
            ? Bt(Object(i), !0).forEach(function (n) {
                Q(t, n, i[n]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i))
            : Bt(Object(i)).forEach(function (n) {
      ...
      var tn,
        ...
        rn = (function () {
          function t(t) {
            (this.zt = t), (this.It = 0), (this.Ct = 0), (this.Ot = S());
          }
          var n = t.prototype;
          return (
            (n.has = function (t) {
      ...
      function on(t, n) {
        return (
          tn ||
            ((tn = self.document.createElement("a")),
            (nn =
              self.__AMP_URL_CACHE || (self.__AMP_URL_CACHE = new rn(100)))),
          (function (t, n, i) {
      ...
      function fn(t) {
        return (
          "https:" == (t = sn(t)).protocol ||
          "localhost" == t.hostname ||
          "127.0.0.1" == t.hostname ||
          p(t.hostname, ".localhost")
        );
      }
      function ln(t, n) {
        var i =
          arguments.length > 2 && void 0 !== arguments[2]
            ...
            : "source";
        return (
          st(null != t, "%s %s must be available", n, i),
          st(
            fn(t) || /^\/\//.test(t),
          ...
          var i = n.getAttribute("content") || "",
            r = on(
              (function (t) {
                ...
                return (
                  st(e.indexOf(".") > 0, "Expected a . in origin %s", e),
                  n.splice(1, "s" == r ? 3 : 2),
                  e +
                    n.join("/") +
                    dn(t.search, "(amp_(js[^&=]*|gsa|r|kit)|usqp)") +
                    (t.hash || "")
                );
              })(t.location.href)
            ).origin;
        ...
        if (!vn(t.location.href))
          for (
            var e = t.location.hostname.split("."),
              u = e[e.length - 1],
              s = (function (t) {
                for (var n = Tn, i = 0; En(t, n); ) n = Tn + i++;
                return n;
              })(t),
              o = e.length - 2;
            o >= 0;
            ...
            if (
              ...
              return yn(t, s, "delete", Date.now() - 1e3, u), u;
        return null;
      }
      ...
      function An(t, n, i) {
        if (n.allowOnProxyOrigin)
          ...
          st(
            !vn(t.location.href),
            "Should never attempt to set cookie on proxy origin: ".concat(i)
          );
      ...
      function Sn(t) {
        return (
          "string" == typeof t && t.startsWith("amp-") && -1 != t.indexOf("{")
        );
      }
      ...
      function Pn(t, n, i) {
        var r = (function (t, n) {
          ...
          return (
            !i && n && (i = t.listeningFors = Object.create(null)), i || null
          );
        })(t, i);
        if (!r) return r;
        var e = r[n];
      ...
      function Cn(t, n) {
        for (var i = n; i && i != i.parent; i = i.parent) if (i == t) return !0;
        return !1;
      }
      function Mn(t) {
        for (var n = { sentinel: Rn }, i = t.length - 1; i >= 0; i--) {
          var r = t[i];
            ...
            (this.yg = (function (t, n, i, r, e, u) {
                            ...
                            (t =
                              "{" == t.charAt(0)
                                ? R(t, function (t) {
                                    et().warn(
                                      "IFRAME-HELPER",
                                      "Postmessage could not be parsed. Is it in a valid JSON format?",
                                      t
                                    );
                                  }) || null
                                : Sn(t)
              ...
              var o,
                a = (function (t, n, i) {
                  ...
                  return (
                    r ||
                      ((r = { frame: n, events: Object.create(null) }),
                      e.push(r)),
                    r.events
                  );
                })(s, t, r),
              ...
              n,
              function (t, n, i) {
                e.Ig.some(function (t) {
                  return t.win == n;
                }) || e.Ig.push({ win: n, origin: i }),
                  r(t, n, i);
              },
              this.Pg,
              this.Pg
        ...
        return (
          (n.send = function (t, n) {
            (function (t, n) {
              ...
              })(this.fb, this.Ig, t, n, this.Pg);
          }),
          (n.destroy = function () {
            this.yg(), (this.Ig.length = 0);
          }),
          t
        );
      })();
      ...
      function Un(t) {
        return (
          t.classList.contains("i-amphtml-fie") || !!U(t, ".i-amphtml-fie")
        );
      }
      function xn(t, n) {
      ...
      function Bn(t, n) {
        ...
        return (function (t) {
          ...
          [
            ...
            [jn.getUserAgent(window), i, r].join(Fn)),
            Math.floor(Date.now() / 6e4) - e,
            t,
          ].join(Fn)
        ).toString(36);
      }
      ...
      var $n = (function () {
          ...
          return (
            (n.get = function (t, n) {
              return t && n
                ? (w(this.RQ, t) || (this.RQ[t] = this.ETt(t)),
                  this.RQ[t] && this.RQ[t][n] ? this.RQ[t][n] : null)
                : (it().error(
            ...
            (n.ETt = function (t) {
              ...
              if (!w(n, t)) return null;
              var i = n[t];
              return (
                this.gTt(this.t.location, t),
                (function (t) {
                  var n = (function (t) {
                    var n = t.split(Fn),
                      i = n.length % 2 == 0;
                    if (n.length < 4 || !i)
                      return (
                        it().error(qn, "Invalid linker_param value ".concat(t)),
                        null
                      );
                    var r = Number(n.shift());
                    return 1 !== r
                      ? (it().error(qn, "Invalid version number ".concat(r)),
                        null)
                      : { checksum: n.shift(), serializedIds: n.join(Fn) };
                  })(t);
                  if (!n) return null;
                  var i = n.checksum,
                    r = n.serializedIds;
                  return (function (t, n) {
                    for (var i = 0; i <= 1; i++) if (Bn(t, i) == n) return !0;
                    return !1;
                  })(r, i)
                    ? (function (t) {
                        for (
                          var n = {}, i = t.split(Fn), r = 0;
                          r < i.length;
                          r += 2
                        ) {
                          var e = i[r];
                          if (Vn.test(e)) {
                            ...
                            it().error(
                              qn,
                              "Invalid linker key ".concat(e, ", value ignored")
                            );
                        }
                        return n;
                      })(r)
                    : (it().error(qn, "LINKER_PARAM value checksum not valid"),
                      null);
                })(i)
              );
            }),
        ...
        ni = (function () {
          ...
          return (
            (n.vs = function () {
              ...
              this.wTt(),
                this.Gy.push(
                  ...
                  this.Ji.onVisibilityChanged(function () {
                    (t.Yn = t.Ji.isVisible()), t.OTt();
                  })
                );
            }),
            (n.wTt = function () {
            ...
            (n.get = function (t, n) {
              return t
                ? w(this.yTt, t) && !ii(this.yTt[t])
                  ? ((this.yTt[t] = this._Tt(this.yTt[t])),
                    null == n || n(this.yTt[t]),
                    this.ITt(t, this.yTt[t]),
                    Promise.resolve(this.yTt[t]))
                  : this.RTt(t, n)
                : (it().error(
                    zn,
            ...
            (n.RTt = function (t, n) {
              ...
              return this.N$.then(function (n) {
                        ...
                        A((n = t))
                          ? (Q((e = {}), Kn, n.sessionId),
                            ...
                            Q(
                              e,
                              Zn,
                              null === (r = n.engaged) || void 0 === r || r
                            ),
                            e)
                          : (et().error(zn, "Invalid stored session value"),
                            ui()),
                        !0
                      )
                    : ui(i.NTt());
                ...
                .then(function (r) {
                  return (
                    (t in i.yTt && !ii(i.yTt[t])) ||
                      (null == n || n(r), i.ITt(t, r), (i.yTt[t] = r)),
                    i.yTt[t]
                  );
                });
            }),
            (n._Tt = function (t, n) {
              ...
              if (ii(t)) {
                ...
                (t.engaged = u || this.NTt()),
                  u && ((this.ATt = !0), (this.STt = !0), (this.Yn = !0));
              }
              return (t.accessTimestamp = r), t;
            }),
            (n.NTt = function () {
              return this.STt && this.Yn && this.ATt;
            }),
            (n.ITt = function (t, n) {
              return this.N$.then(function (i) {
                var r = ei(t);
                i.setNonBoolean(r, n);
              });
            }),
      ...
      function li(t, n, i) {
        var r = Number(n),
          e = t.length;
        return (
          st(N(r), "Start index " + r + "in substr macro should be a number"),
          i &&
            st(
              N((e = Number(i))),
              "Length " + e + " in substr macro should be a number"
            ),
          t.substr(r, e)
        );
      }
      ...
      var Ti = (function () {
        function t(t) {
          ...
          (this.Ji = t),
            (this.MU = {}),
            (this.TQ = ot(this.Ji.win, "amp-analytics-linker-reader")),
            (this.PTt = si(this.Ji)),
            this.IF("$DEFAULT", vi),
            this.IF("$SUBSTR", li),
            this.IF("$TRIM", function (t) {
              return t.trim();
            }),
            this.IF("$TOLOWERCASE", function (t) {
              return t.toLowerCase();
            }),
            this.IF("$TOUPPERCASE", function (t) {
              return t.toUpperCase();
            }),
            this.IF("$NOT", function (t) {
              return String(!t);
            }),
            this.IF("$BASE64", function (t) {
              return Qt(t);
            }),
            this.IF("$HASH", this.CTt.bind(this)),
            this.IF("$IF", function (t, n, i) {
              return Si(t) ? n : i;
            }),
            this.IF("$REPLACE", di),
            this.IF("$MATCH", mi),
            this.IF("$CALC", pi),
            this.IF("$EQUALS", function (t, n) {
              return t === n;
            }),
            this.IF("LINKER_PARAM", function (t, i) {
              return n.TQ.get(t, i);
            }),
            this.IF("TIMEZONE_CODE", function () {
              var t = "";
              return (
                "Intl" in n.Ji.win &&
                  "DateTimeFormat" in n.Ji.win.Intl &&
                  (t = new n.Ji.win.Intl.DateTimeFormat().resolvedOptions()
                    .timeZone),
                t
              );
            }),
            this.IF("SCROLL_TOP", function () {
              return Math.round(Ct(n.Ji).getScrollTop());
            }),
            this.IF("SCROLL_LEFT", function () {
              return Math.round(Ct(n.Ji).getScrollLeft());
            }),
            this.IF("EXPERIMENT_BRANCHES", function (t) {
              return (function (t, n) {
                if (n)
                  return (
                    (function (t, n) {
                      return t.__AMP_EXPERIMENT_BRANCHES
                        ? t.__AMP_EXPERIMENT_BRANCHES[n]
                        : null;
                    })(t, n) || ""
                  );
                var i = (function (t) {
            ...
            this.IF("AMPDOC_META", function (t) {
              var i,
                r =
                  arguments.length > 1 && void 0 !== arguments[1]
                    ? arguments[1]
                    : "";
              return null !== (i = n.Ji.getMetaByName(t)) && void 0 !== i
                ? i
                : r;
            });
        }
        ...
        return (
              ...
              e = Un(t)
                ...
                : {
                    FIRST_CONTENTFUL_PAINT: function () {
                      return Ot(n.Ji.win).getMetric("fcpv");
                    },
                    FIRST_VIEWPORT_READY: function () {
                      return Ot(n.Ji.win).getMetric("pc");
                    },
                    MAKE_BODY_VISIBLE: function () {
                      return Ot(n.Ji.win).getMetric("mbv");
                    },
                    LARGEST_CONTENTFUL_PAINT: function () {
                      return Ot(n.Ji.win).getMetric("lcpv");
                    },
                    FIRST_INPUT_DELAY: function () {
                      return Ot(n.Ji.win).getMetric("fid");
                    },
                    CUMULATIVE_LAYOUT_SHIFT: function () {
                      return Ot(n.Ji.win).getMetric("cls");
                    },
                    INTERACTION_TO_NEXT_PAINT: function () {
                      return Ot(n.Ji.win).getMetric("inp");
                    },
                  };
            return Wt(Wt(Wt({}, this.MU), r), e);
          }),
          (n.MTt = function (t, n) {
              ...
              (o = function (t, u) {
                if (n.iterations < 0)
                  return (
                    it().error(
                      ai,
                      "Maximum depth reached while expanding variables. Please ensure that the variables are not recursive."
                    ),
                    t
                  );
                if (!u) return "";
          ...
          (n.DTt = function (t, n, i, r, e, u, s) {
            ...
            return this.expandTemplate(
              t,
              new fi(n.vars, n.iterations - 1, !0),
              i,
              e,
              u
            ).then(function (t) {
          ...
          (n.CTt = function (t) {
            return wt(this.Ji.win).sha384Base64(t);
          }),
          t
        );
      })();
      ...
      function Ei(t) {
        if (!t) return { name: "", argList: "" };
        var n = t.match(hi);
        return (
          st(n, "Variable with invalid format found: " + t),
          { name: n[1] || n[0], argList: n[2] || "" }
        );
      }
      function gi(t) {
      ...
      var wi = "amp-analytics/config",
        Oi = (function () {
          ...
          var n = t.prototype;
          return (
            (n.loadConfig = function () {
              var t = this;
              return (
                (this.t = this.ql.ownerDocument.defaultView),
                (this.UTt = this.ql.hasAttribute("sandbox")),
                Promise.all([this.xTt(), this.jTt()])
                  .then(this.HTt.bind(this))
                  .then(this.FTt.bind(this))
                  .then(function () {
                    return t.nk;
                  })
              );
            ...
            (n.VTt = function (t) {
              var n,
                i = (this.t.location, Z.cdn),
                r =
                  "bg" === t &&
                  null !== (n = self.AMP_CONFIG) &&
                  void 0 !== n &&
                  n.canary
                    ? ".canary"
                    : "";
              return ""
                .concat(i, "/rtv/")
                .concat(K().rtvVersion, "/v0/analytics-vendors/")
                .concat(t)
                .concat(r, ".json");
            }),
            (n.jTt = function () {
              var t = this,
                n = this.ql.getAttribute("type");
              if (!n) return e();
              var i = this.VTt(n),
                r = this.qn();
              return (
                et().fine(r, "Fetching vendor config", i),
                Mt(this.t)
                  .fetchJson(i, { ampCors: !1 })
                  .then(function (t) {
                    return t.json();
                  })
                  .then(
            ...
            (n.xTt = function () {
              var t = this,
                n = this.ql.getAttribute("config");
              if (!n || this.UTt) return e();
              ln(n, this.ql);
              var i = this.qn();
              ...
              return (
                ...
                _t(this.ql)
                  .expandUrlAsync(n, this.cA.getMacros(this.ql))
                  .then(function (i) {
            ...
            (n.HTt = function () {
              ...
              return (
                ...
                Ni(i, n),
                Ni(this.kTt, n),
                !t || this.UTt ? ((this.nk = this.BTt(n)), e()) : this.WTt(n, t)
              );
            }),
            (n.WTt = function (t, n) {
              var i = this;
              ...
              var r = this.qn();
              return (
                et().fine(r, "Rewriting config", n),
                this.$Tt(t).then(function () {
                  var e = { method: "POST", body: t };
                  return (
                    i.ql.hasAttribute("data-credentials") &&
            ...
            (n.FTt = function () {
              if (this.nk.warningMessage) {
                var t = this.qn(),
                  n = this.ql.getAttribute("type"),
                  i = this.ql.getAttribute("config");
                it().warn(
                  t,
                  "Warning from analytics vendor%s%s: %s",
                  n ? " " + n : "",
                  i ? " with remote config url " + i : "",
                  String(this.nk.warningMessage)
                ),
                  delete this.nk.warningMessage;
              }
            }),
            (n.$Tt = function (t) {
              var n = this,
              ...
              return (
                ...
                Object.keys(h).forEach(function (t) {
                  var i = h[t];
                  if (i.enabled) {
                    var r = n.shallowExpandObject(n.ql, i).then(function (t) {
            ...
            (n.qTt = function () {
              return this.Cyt.configRewriter || {};
            }),
            (n.G$ = function () {
              if (this.ql.CONFIG) return this.ql.CONFIG;
              var t = {},
                n = this.qn();
              try {
                var i = this.ql.children;
                1 == i.length
                  ? (t = (function (t) {
                      var n,
                        i,
                        ...
                        e =
                          ...
                          (i = n),
                          (r = "> ".concat("script")),
                          C(i) ? i.querySelectorAll(M(r, ":scope")) : D(i, r)),
                        u = e.length;
                      if (1 !== u)
                        throw new Error(
                          "Found ".concat(u, " <script> children. Expected 1.")
                        );
                      var s = e[0];
                      if (
                        !(function (t) {
                      ...
                      try {
                        var o;
                        return _(
                          null !== (o = s.textContent) && void 0 !== o ? o : ""
                        );
                      } catch (t) {
                        throw new Error(
            ...
            (n.GTt = function (t) {
              if (
                this.ql.getAttribute("type") &&
                (t.transport || this.kTt.transport)
              ) {
                var n = this.qn();
                it().error(
                  n,
            ...
            (n.qn = function () {
              return (
                "AmpAnalytics " + (this.ql.getAttribute("id") || "<unknown id>")
              );
            }),
      ...
      function Ni(t, n, i) {
        ...
        st(
          i ||
            ...
            "__gaOptOutExtension" == t.optoutElementId,
        ...
        t))
          st(
            ...
            w(t, r) &&
              (d(t[r])
                ? (d(n[r]) || (n[r] = []), (n[r] = Ni(t[r], n[r], i)))
                : A(t[r])
                ? (A(n[r]) || (n[r] = {}), (n[r] = Ni(t[r], n[r], i)))
                : (n[r] = t[r]));
        return n;
      }
      function Ii(t) {
        ...
        for (var n in t.requests)
          w(t.requests, n) &&
            (t.requests[n] = A((i = t.requests[n])) ? i : { baseUrl: i });
        var i;
        return (function (t) {
          ...
          return (
            ...
            (i.Hn = function (t) {
              for (
                ...
                if (this.Ln[n].priority < t) i = n + 1;
                else {
                  if (!(n > 0 && this.Ln[n - 1].priority >= t)) break;
                  r = n - 1;
                }
              return n;
            }),
            (i.forEach = function (t) {
              for (var n = this.length; n--; ) t(this.Ln[n].item);
            }),
            (i.dequeue = function () {
              var t = this.Ln.pop();
      ...
      var ki,
        ...
        xi = (function () {
          ...
          return (
            ...
            (n.qn = function () {
              return this.Vn.displayName || this.Vn.name;
            }),
            (n.Bn = function (t) {}),
            (n.$n = function () {
              return !1;
        ...
        ji = (function (t) {
          ...
          return (
            ...
            (r.Yn = function () {
              return this.Kn.ampdoc.isVisible();
            }),
            i
          );
        })(xi),
        Hi = (function () {
          function t(t) {
            ...
            (this.ampdoc = t),
              ...
              (this.nr = !1),
              (this.Gn = this.t.document.documentElement.hasAttribute(
                "i-amphtml-no-boilerplate"
              )),
              this.t.addEventListener("message", function (t) {
                "amp-macro-task" == kt(t) && i.Zn(null);
              }),
              (this.Jn = !1),
              ((n = t), ct(n, "viewer")).then(function () {
                i.Jn = !0;
              }),
          ...
          return (
            ...
            (n.runForStartup = function (t) {
              ...
              this.er(n, Number.POSITIVE_INFINITY);
            }),
            (n.er = function (t, n) {
              this.Xn.enqueue(t, n), this.rr();
            }),
            (n.sr = function (t) {
              for (var n = this.Xn.peek(); n && n.state !== Ui; )
                this.Xn.dequeue(), (n = this.Xn.peek());
              return n && t && this.Xn.dequeue(), n;
            }),
            (n.Zn = function (t) {
              var n,
                i = this,
                r = this.sr(!0);
              if (!r) return (this.nr = !1), (this.tr = 0), !1;
              try {
                (n = Date.now()), r.Fn(t);
              } finally {
                Di.then()
            ...
            (n.rr = function () {
              if (!this.nr) {
                ...
                if (t)
                  return t.$n()
                    ? ((this.nr = !0), void this.ur(null))
                    : void (t.Wn() && this.t.requestIdleCallback
                        ? ((n = this.t),
                          (i = 2e3),
                          (r = this.Qn),
                          (e = Date.now()),
                              ...
                              if (u.timeRemaining() < 15) {
                                ...
                                s <= 0 || u.didTimeout
                                  ...
                                  : (et().fine(
                                    ...
                                    n.requestIdleCallback(t, { timeout: s }));
                              } else
                                et().fine(
                                  Ci,
        ...
        qi = (function () {
          ...
          return (
            ...
            (n.vs = function () {
              if (!xn(this.t, this.ql)) return e();
              if (!w(this.nk, "cookies")) return e();
              if (!A(this.nk.cookies))
                return it().error(Fi, "cookies config must be an object"), e();
              var t = this.nk.cookies;
              if (!1 === t.enabled) return e();
              for (
                var n = this.HQ(t), i = Object.keys(t), r = [], u = 0;
                u < i.length;
                u++
              ) {
                var s = i[u],
                  o = t[s],
                  a = this.zTt(
                    o.sameSite || o.SameSite || t.sameSite || t.SameSite
                  );
                this.FQ(s, o) && r.push(this.VQ(s, o.value, n, a));
              }
              return Promise.all(r);
            }),
            (n.HQ = function (t) {
              if (!w(t, "cookieMaxAge")) return _i;
            ...
            (n.VQ = function (t, n, i, r) {
              var e = this;
              return this.HC.expandStringAsync(n, this.Bh)
                .then(function (n) {
                  if (n) {
                    var u = Date.now() + i,
                      s = r === bn;
                    !(function (t, n, i, r) {
                      ...
                      e.domain
                        ? (u = e.domain)
                        : e.highestAvailableDomain && (u = gn(t)),
        ...
        Gi = (function () {
          ...
          return (
            ...
            (n.remove = function (t) {
              ...
              this.vt &&
                ((i = t),
                -1 != (r = (n = this.vt).indexOf(i)) && n.splice(r, 1));
            }),
            ...
            (n.fire = function (t) {
              if (this.vt)
                for (var n, r = i(this.vt.slice(), !0); !(n = r()).done; )
                  (0, n.value)(t);
            }),
            (n.getHandlerCount = function () {
              ...
              return null !==
                (t =
                  null === (n = this.vt) || void 0 === n ? void 0 : n.length) &&
                void 0 !== t
                ? t
                : 0;
            }),
      ...
      var vr = function (t, n) {
        ...
        dr = (function () {
          ...
          var n = t.prototype;
          return (
            (n.dispose = function () {}), (n.add = function (t, n, i, r) {}), t
          );
        })(),
        mr = (function (t) {
          a(r, t);
          ...
          return (
            ...
            (e.add = function (t, n, r, e) {
              ...
              st(
                ...
                (u = (function (t) {
                  ...
                  var a = Wt(
                    Wt(
                      {},
                      null !== (n = t.AMP_CONFIG) && void 0 !== n ? n : {}
                    ),
                  ...
                  if (d(b) && b.length)
                    for (
                      var E,
                        g = $(t.location.originalHash || t.location.hash),
                        y = i(b, !0);
                      !(E = y()).done;
              ...
              return (
                this.JTt[s] ||
                  (this.root.getRootElement().addEventListener(s, this.ZTt, !0),
                  (this.JTt[s] = !0)),
          ...
          return (
            ...
            (r.add = function (t, n, i, r) {
              ...
              var s = i.selectionMethod || null,
                ...
                h = a ? this.tEt && this.tEt[n] : this.QTt && this.QTt[n];
              if (h) {
                var c = h.length;
                o.then(function (t) {
                  setTimeout(function () {
            ...
            (r.trigger = function (t) {
              ...
              (r && (r.fire(t), i)) ||
                (i
                  ? ((this.tEt[n] = this.tEt[n] || []), this.tEt[n].push(t))
                  : this.QTt &&
                    ((this.QTt[n] = this.QTt[n] || []), this.QTt[n].push(t)));
            }),
            i
          );
        })(dr),
        Tr = (function (t) {
          ...
          return (
            (r.add = function (t, n, i, r) {
              ...
              var c = this.KTt[n];
              return (
                c || ((c = new Gi()), (this.KTt[n] = c)),
                this.KTt[n].add(function (t) {
                  e.nEt(t, u, i, r);
                })
              );
            }),
            (r.nEt = function (t, n, i, r) {
              var e = t.type,
                u = t.vars,
                s = i.storySpec || {},
                ...
                a = u.eventDetails,
                h = i.tagName;
              (h && a.tagName && h.toLowerCase() !== a.tagName) ||
                (!1 === o && a.repeated) ||
                r(new vr(n, e, u));
            }),
            (r.trigger = function (t) {
        ...
        br = (function (t) {
          ...
          function i(t) {
            var i;
            return (
              ((i = n.call(this, t)).iEt = new Gi()),
              (i.rEt = i.iEt.fire.bind(i.iEt)),
              i.root.getRoot().addEventListener("click", i.rEt),
              i
            );
          }
          var r = i.prototype;
          return (
            (r.dispose = function () {
              this.root.getRoot().removeEventListener("click", this.rEt),
                this.iEt.removeAll();
            }),
            (r.add = function (t, n, i, r) {
              var e = st(
        ...
        Er = (function (t) {
          ...
          function i(t) {
            var i;
            return ((i = n.call(this, t)).ge = t), (i.eEt = null), i;
          }
          var r = i.prototype;
          return (
            (r.dispose = function () {
              null !== this.eEt &&
                (this.ge.getScrollManager().removeScrollHandler(this.eEt),
                (this.eEt = null));
            }),
            (r.add = function (t, n, i, r) {
              if (!i.scrollSpec)
                return (
                  it().error(Ki, "Missing scrollSpec on scroll trigger."), zi
                );
              if (
                !Array.isArray(i.scrollSpec.verticalBoundaries) &&
                !Array.isArray(i.scrollSpec.horizontalBoundaries)
              )
                return (
                  it().error(
                    Ki,
              ...
              var e = this.uEt(i.scrollSpec.verticalBoundaries),
                u = this.uEt(i.scrollSpec.horizontalBoundaries),
                s = !!i.scrollSpec.useInitialPageSize;
              return (
                (this.eEt = this.$l.bind(this, u, e, s, r)),
                this.ge.getScrollManager().addScrollHandler(this.eEt)
              );
            }),
            (r.$l = function (t, n, i, r, e) {
              var u = i ? e.initialSize : e,
                s = u.scrollHeight,
                o = u.scrollWidth;
              this.sEt(
                n,
                (100 * (e.top + e.height)) / s,
                "verticalScrollBoundary",
                r
              ),
                this.sEt(
                  t,
                  (100 * (e.left + e.width)) / o,
            ...
            (r.uEt = function (t) {
              ...
              for (var i = 0; i < t.length; i++) {
                ...
                if ("number" != typeof r || !isFinite(r))
                  return (
                    it().error(Ki, "Scroll trigger boundaries must be finite."),
                    n
                  );
                ...
                for (var e in t)
                  if (w(t, e)) {
                    ...
                    if (!(u > n || t[u])) {
                      ...
                      var s = {};
                      (s[i] = e),
                        r(new vr(this.ge.getRootElement(), ir, s, !1));
                    }
                  }
            }),
            i
          ...
          return (
            ...
            (r.add = function (t, n, i, r) {
              var e,
                ...
                o = i.selector || ":root";
              if (":root" == o || ":host" == o)
                (e = this.root.getRootElement()), (u = this.getRootSignal(n));
              else {
                var a = i.selectionMethod;
                u = this.root
                  .getAmpElement(t.parentElement || t, o, a)
                  .then(function (t) {
            ...
            (r.getElementSignal = function (t, n) {
              return "function" != typeof n.signals
                ? e()
                : n.signals().whenSignal(t);
            }),
            i
          );
        })(dr),
          ...
          return (
            ...
            (r.add = function (t, n, i, r) {
              var e,
                ...
                o = i.selector || ":root";
              if (":root" == o || ":host" == o)
                (e = this.root.getRootElement()), (u = this.getRootSignal());
              else {
                var a = i.selectionMethod;
                u = this.root
                  .getAmpElement(t.parentElement || t, o, a)
            ...
            (r.getElementSignal = function (t, n) {
              ...
              var i = n.signals();
              return Promise.race([
                i.whenSignal("ini-load"),
                i.whenSignal("load-end"),
              ]);
            }),
            i
          );
        ...
        Ar = (function () {
          function t(t, n, i) {
            (this.oEt = void 0),
              ...
              (this.aEt = Number(t.interval) || 0),
              st(this.aEt >= 0.5, "Bad timer interval specification"),
              (this.hEt =
                "maxTimerLength" in t ? Number(t.maxTimerLength) : 7200),
              st(this.hEt > 0, "Bad maxTimerLength specification"),
              (this.cEt = "maxTimerLength" in t),
              (this.fEt = !("immediate" in t) || Boolean(t.immediate)),
              (this.lEt = null),
              (this.vEt = null),
              (this.dEt = null),
              (this.mEt = n || null),
          ...
          return (
            ...
            (n.bEt = function () {
              this.mEt && (this.vEt = this.mEt());
            }),
            (n.gEt = function () {
              this.vEt && (this.vEt(), (this.vEt = null));
            }),
            (n.yEt = function () {
              if (this.pEt)
                try {
            ...
            (n.EEt = function () {
              this.dEt && (this.dEt(), (this.dEt = null));
            }),
            ...
            (n.startIntervalInWindow = function (t, n, i) {
              this.isRunning() ||
                ...
                (this.TEt = void 0),
                (this.lEt = n),
                (this.oEt = t.setInterval(function () {
                  n();
                }, 1e3 * this.aEt)),
                (!this.pEt || (this.pEt && this.cEt)) &&
            ...
            (n.SEt = function () {
              return this.Hh ? Date.now() - (this.TEt || this.Hh) : 0;
            }),
            (n.getTimerVars = function () {
              var t = 0;
              return (
                this.isRunning() && ((t = this.SEt()), (this.TEt = Date.now())),
                { timerDuration: t, timerStart: this.Hh || 0 }
              );
            }),
            t
          );
        ...
        Sr = (function (t) {
          ...
          function i(t) {
            var i;
            return ((i = n.call(this, t)).wEt = {}), (i.OEt = 1), i;
          }
          var r = i.prototype;
          return (
            (r.getTrackedTimerKeys = function () {
              return Object.keys(this.wEt);
            }),
            (r.dispose = function () {
              var t = this;
            ...
            (r.add = function (t, n, i, r) {
              ...
              if (s) {
                ...
                st(l, "Cannot track timer start"),
                  (a = l.add.bind(l, t, s.on, s, this.REt.bind(this, f, n, r)));
              }
              if (o) {
                var v = this._Et(o);
                st(v, "Cannot track timer stop"),
                  (h = v.add.bind(v, t, o.on, o, this.REt.bind(this, f, n, r)));
              }
              var d = new Ar(u, a, h);
              return (
                (this.wEt[f] = d),
                d.init(this.PEt.bind(this, f, n, r)),
                function () {
                  e.NEt(f);
                }
              );
            ...
            (r.REt = function (t, n, i) {
              var r = this.wEt[t];
              r && (r.isRunning() ? this.AEt(t) : this.PEt(t, n, i));
            }),
            (r.PEt = function (t, n, i) {
              var r = this;
              this.wEt[t].startIntervalInWindow(
                this.root.ampdoc.win,
                function () {
                  i(r.CEt(t, n));
                },
                this.NEt.bind(this, t)
              );
            }),
            (r.AEt = function (t) {
              this.wEt[t].AEt(this.root.ampdoc.win);
            }),
            (r.CEt = function (t, n) {
              return new vr(
                this.root.getRootElement(),
                n,
                this.wEt[t].getTimerVars(),
                !1
              );
            }),
            (r.NEt = function (t) {
              this.wEt[t] &&
                (this.AEt(t), this.wEt[t].dispose(), delete this.wEt[t]);
            }),
            i
          );
        })(dr),
        wr = (function (t) {
          ...
          function i(t) {
            var i;
            return (
              ((i = n.call(this, t)).MEt = new Gi()),
              (i.XTt = i.MEt.fire.bind(i.MEt)),
              $i.forEach(function (t) {
          ...
          return (
            ...
            (r.add = function (t, n, i, r) {
              ...
              var s = i.selectionMethod || null,
                ...
                v = 0,
                d = 0;
              return this.MEt.add(function (t) {
                var n = t.type,
                  i = kt(t),
                  e = (function (t, n) {
                    return t == Bi
                      ? "video-session"
                      : "video-hosted-custom" == t
                      ? n["__amp:eventType"]
                      : t;
                  })(n, i);
                if (e === l)
                      ...
                      if ("video-percentage-played" === e) {
                        ...
                        for (var u = 0; u < f.length; u++) {
                          ...
                          if (s <= 0 || s % 5 != 0)
                            return void it().error(
                              Ki,
                              "Percentages must be set in increments of %s with non-zero values",
                              5
                            );
                        }
                        var m = i.normalizedPercentage,
                          p = parseInt(m, 10);
                        if ((ut(N(p)), ut(p % 5 == 0), d == p && f.length > 1))
                          return;
          ...
          return (
            ...
            (r.add = function (t, n, i, r) {
              var e = this,
                ...
                h = null;
              a &&
                st(!u.repeat, "reportWhen and repeat are mutually exclusive."),
                n === Qi &&
                  (a &&
                    it().error(
                      Ki,
              ...
              if (
                ("documentHidden" == a
                  ? (h = this.LEt.bind(this))
                  : "documentExit" == a
                  ? (h = this.kEt.bind(this))
                  : st(!a, 'reportWhen value "%s" not supported.', a),
                !s || ":root" == s || ":host" == s)
              ) {
                var f = o || (s ? "ini-load" : "none");
                return c.listenRoot(
                  u,
                  this.getReadyPromise(f),
                  h,
                  this.UEt.bind(this, n, r, this.root.getRootElement())
                );
              }
              var l = i.selectionMethod || u.selectionMethod;
              hr(s);
              var v = this.root
                .getElements(t.parentElement || t, s, l)
                .then(function (t) {
                  for (var i = [], s = 0; s < t.length; s++)
                    i.push(
                      c.listenElement(
                        t[s],
                        u,
                        e.getReadyPromise(o, t[s]),
                        h,
                        e.UEt.bind(e, n, r, t[s])
                      )
                    );
                  return i;
                });
            ...
            (r.getReadyPromise = function (t, n) {
              ...
              if (
                (n &&
                  ((i = n.tagName).startsWith("AMP-") &&
                  "AMP-STICKY-AD-TOP-PADDING" != i &&
                  "AMP-BODY" != i
                    ? (t = t || "ini-load")
                    : st(
                        !t || "none" == t,
              ...
              var e = this.DEt[t] || this.root.getTrackerForAllowlist(t, r);
              return e
                ? ((this.DEt[t] = e),
                  n ? e.getElementSignal(t, n) : e.getRootSignal(t))
                : null;
            }),
            (r.UEt = function (t, n, i, r) {
              var e = j(i, void 0, Yi);
          ...
          return (
            ...
            (n.addTrigger = function (t, n) {
              var i,
                ...
                e = t.on,
                s = cr(e),
                o = fr(this.ge.getType()),
                a = this.ge.getTrackerForAllowlist(s, o);
              st(
                !!a,
              ...
              var h = new u(),
                c = function () {
                  (i = a.add(r.jEt, e, t, n)), r.rn.push(i), h.resolve();
                };
              if (this.HEt < 1 || "inabox" == K(this.t).runtime) c();
              else {
                var f = this.HEt < 3 ? 20 : 10;
                Li(this.jEt, c, f);
              }
              return this.HEt++, h.promise;
            }),
            t
          );
        })(),
      ...
      var Pr = (function () {
        function t(t) {
          (this.eo = Ct(t.ampdoc)),
            (this.Zu = at(t.ampdoc, "mutator")),
            (this.FEt = null),
            (this.hc = new Gi()),
            (this.ge = t.getRootElement()),
            (this.VEt = null);
        }
        var n = t.prototype;
        return (
          (n.dispose = function () {
            this.hc.removeAll(), this.qEt();
          }),
          (n.removeScrollHandler = function (t) {
            this.hc.remove(t), this.hc.getHandlerCount() <= 0 && this.qEt();
          }),
          (n.addScrollHandler = function (t) {
            var n = this,
              i = this.eo.getSize();
            return (
              this.GEt().then(function (r) {
                var e = r.height,
                  u = r.left,
                  s = r.top,
                  o = r.width,
                  a = {
                    top: n.eo.getScrollTop() - s,
                    left: n.eo.getScrollLeft() - u,
                    width: i.width,
                    height: i.height,
                    scrollHeight: e,
                    scrollWidth: o,
                    initialSize: { scrollHeight: e, scrollWidth: o },
                  };
                t(a);
              }),
              0 === this.hc.getHandlerCount() && this.BEt(),
              this.hc.add(t)
            );
          }),
          (n.bF = function (t) {
            var n = this;
            return Promise.all([this.GEt(), this.WEt()]).then(function (i) {
              var r = i[0],
                e = r.height,
                u = r.width,
                s = i[1],
                ...
                f = {
                  ...
                  scrollWidth: c,
                  scrollHeight: o,
                  initialSize: { scrollHeight: e, scrollWidth: u },
                };
              n.hc.fire(f);
            });
          }),
          (n.qEt = function () {
            this.FEt && (this.FEt(), (this.FEt = null));
          }),
          (n.BEt = function () {
            this.FEt = this.eo.onChanged(this.bF.bind(this));
          }),
          (n.GEt = function () {
            return ut(this.VEt || this.WEt());
          }),
          (n.WEt = function () {
            var t = this,
              n = this.Zu.measureElement(function () {
                return t.eo.getLayoutRect(t.ge);
              });
            return (this.VEt = this.VEt || n), n;
          }),
          t
        );
      })();
        ...
        var n = (function (t) {
          ...
          for (var e = 0; e < 50; e++)
            if ((i = r.parentNode || r.parentElement) && 1 == i.nodeType)
              ...
              if (
                !(i = r.ownerDocument.defaultView.frameElement) ||
                1 != i.nodeType
              )
                break;
              (r = i), n.push(r);
      ...
      var Dr = (function () {
        function t(t, n) {
          ...
          (this.$Et = n),
            ...
            "0" === String(t.visiblePercentageMax).trim() &&
              (this.YEt.visiblePercentageMax = 0),
            (this.zEt = void 0 !== t.reportWhen),
            (this.KEt = !0 === t.repeat),
            (this.JEt = new Gi());
          var r = new u();
          (this.XEt = r.promise),
            (this.ZEt = r.resolve),
            this.XEt.then(function () {
              i.JEt.fire();
            }),
            (this.QEt = []),
            (this.Ogt = Date.now()),
        ...
        return (
          ...
          (n.maybeDispose = function () {
            this.KEt || this.dispose();
          }),
          (n.dispose = function () {
            this.Cgt && (clearTimeout(this.Cgt), (this.Cgt = null)),
              this.Ygt && (clearTimeout(this.Ygt), (this.Ygt = null)),
              this.QEt.forEach(function (t) {
                t();
              }),
              (this.QEt.length = 0),
              (this.ZEt = null),
              this.JEt && (this.JEt.removeAll(), (this.JEt = null));
          }),
          (n.unsubscribe = function (t) {
            this.QEt.push(t);
          }),
          (n.onTriggerEvent = function (t) {
            this.JEt && this.JEt.add(t), this.XEt && !this.ZEt && t();
          }),
          (n.setReady = function (t) {
            (this.xi = t), this.update();
          }),
          (n.setReportReady = function (t) {
            (this.Ngt = !1), (this.Igt = t);
          }),
          (n.zgt = function () {
            return this.xi ? this.$Et() : 0;
          }),
          (n.update = function () {
            this.yl(this.zgt());
          }),
          (n.getState = function (t) {
            return {
              firstSeenTime: Lr(this.jgt, t),
              lastSeenTime: Lr(this.Hgt, t),
              lastVisibleTime: Lr(this.vi, t),
              firstVisibleTime: Lr(this.hu, t),
              maxContinuousVisibleTime: this.Ugt,
              totalVisibleTime: this.xgt,
              loadTimeVisibility: 100 * this.Fgt || 0,
              minVisiblePercentage: 100 * this.Vgt,
              maxVisiblePercentage: 100 * this.qgt,
            };
          }),
          (n.yl = function (t) {
            var n = this;
            if (this.$gt) this.Kgt(t) || this.Ur();
            else if (this.ZEt)
              if (this.Jgt(t) || this.zEt) {
                if (
                  (this.Cgt && (clearTimeout(this.Cgt), (this.Cgt = null)),
                  this.Ngt)
                )
              ...
              } else if (this.Mgt && !this.Cgt) {
                var r = this.Xgt();
                r > 0 &&
                  (this.Cgt = setTimeout(function () {
                    (n.Cgt = null), n.update();
                  }, r));
              } else
                !this.Mgt &&
                  this.Cgt &&
                  (clearTimeout(this.Cgt), (this.Cgt = null));
          }),
          (n.Kgt = function (t) {
            return (
              ut(t >= 0 && t <= 1),
              1 == this.YEt.visiblePercentageMin
                ? 1 == t
                : 0 == this.YEt.visiblePercentageMax
                ? 0 == t
                : t > this.YEt.visiblePercentageMin &&
                  t <= this.YEt.visiblePercentageMax
            );
          }),
          (n.Jgt = function (t) {
            ut(t >= 0 && t <= 1);
            ...
            t > 0 &&
              ((this.jgt = this.jgt || n),
              (this.Hgt = n),
              !this.Fgt && n - this.Ogt < 300 && (this.Fgt = t));
            var i = this.Mgt,
              r = this.Ggt ? n - this.Ggt : 0;
            return (
              (this.Mgt = this.Kgt(t)),
              this.Mgt
                ? ((this.Dgt = !0),
                  i
                    ? ((this.xgt += r),
                      (this.Lgt += r),
                      (this.Ugt = Math.max(this.Ugt, this.Lgt)))
                    : (ut(!this.Ggt), (this.hu = this.hu || n)),
                  (this.Ggt = n),
                  (this.Vgt = this.Vgt > 0 ? Math.min(this.Vgt, t) : t),
                  (this.qgt = Math.max(this.qgt, t)),
                  (this.vi = n))
                : i &&
                  (ut(this.Ggt > 0),
                  (this.Ugt = Math.max(this.Ugt, this.Lgt + r)),
                  (this.Ggt = 0),
                  (this.xgt += r),
                  (this.Lgt = 0),
                  (this.vi = n)),
              this.Dgt &&
                this.xgt >= this.YEt.totalTimeMin &&
                this.xgt <= this.YEt.totalTimeMax &&
                this.Ugt >= this.YEt.continuousTimeMin &&
                this.Ugt <= this.YEt.continuousTimeMax
            );
          }),
          (n.maybeSetInitialScrollDepth = function (t) {
            this.Wgt || ((this.Bgt = t), (this.Wgt = !0));
          }),
          (n.getInitialScrollDepth = function () {
            return this.Bgt;
          }),
          (n.Xgt = function () {
            var t = Math.max(this.YEt.continuousTimeMin - this.Lgt, 0),
              n = Math.max(this.YEt.totalTimeMin - this.xgt, 0),
              i = Math.max(t, n);
      ...
      var Vr = (function () {
          function t(t, n) {
            ...
            (this.parent = t),
              ...
              (this.QEt = []),
              (this.tAt = 0),
              this.parent && this.parent.nAt(this);
          ...
          return (
            ...
            (n.iAt = function (t) {
              if (this.tZ) {
                var n = this.tZ.indexOf(t);
                -1 != n && this.tZ.splice(n, 1);
              }
            }),
            (n.dispose = function () {
              this.setRootVisibility(0);
              for (var t = this.Qgt.length - 1; t >= 0; t--)
                this.Qgt[t].dispose();
              if (
                (this.QEt.forEach(function (t) {
                  t();
                ...
                (this.QEt.length = 0),
                this.parent && this.parent.iAt(this),
                this.tZ)
              )
            ...
            (n.getRootVisibility = function () {
              return this.parent
                ? this.parent.getRootVisibility() > 0
                  ? this.Zgt
                  : 0
                : this.Zgt;
            }),
            (n.setRootVisibility = function (t) {
              if (((this.Zgt = t), this.rAt(), this.tZ))
                for (var n = 0; n < this.tZ.length; n++) this.tZ[n].rAt();
            }),
            ...
            (n.rAt = function () {
              for (var t = 0; t < this.Qgt.length; t++) this.Qgt[t].update();
            }),
            ...
            (n.eAt = function (t, n, i, r, e, u) {
              if (
                n.visiblePercentageThresholds &&
                null == n.visiblePercentageMin &&
                null == n.visiblePercentageMax
              ) {
                var s = [],
                  o = n.visiblePercentageThresholds;
                if (!o || !d(o))
                  return (
                    it().error(kr, "invalid visiblePercentageThresholds"),
                    function () {}
                  );
            ...
            (n.NT = function (t, n, i, r, e, u) {
              ...
              var o = Ct(this.ampdoc),
                a = o.getScrollTop();
              return (
                this.maybeUpdateMaxScrollDepth(a),
                i
                  ? (t.setReady(!1),
                    i.then(function () {
                ...
                t.onTriggerEvent(function () {
                  var n,
                    ...
                    r = t.getState(i);
                  if (
                    ((r.backgrounded = s.isBackgrounded() ? 1 : 0),
                  ...
                  t.maybeDispose(),
                    n &&
                      ...
                      (r.initialScrollDepth = Rr(
                        n,
                        o,
                        t.getInitialScrollDepth()
                      )),
                ...
                t.unsubscribe(function () {
                  var n = s.Qgt.indexOf(t);
                  -1 != n && s.Qgt.splice(n, 1);
                }),
                u &&
                  t.unsubscribe(
                    this.observe(u, function () {
                      return t.update();
                    })
                  ),
                t.update(),
        ...
        qr = (function (t) {
          ...
          function i(t) {
            var i;
            if (
              (((i = n.call(this, null, t)).eo = Ct(t)),
              (i.uAt = !t.isVisible()),
              (i.sAt = i.isBackgrounded()),
              (i.oAt = S()),
              (i.Gg = null),
              ...
              var u = function () {
                var t = Hr(e),
                  n = i.oAt[t];
                n &&
                  (i.ampdoc.win.innerHeight < 1 || i.ampdoc.win.innerWidth < 1
                    ? (n.isVisible = !1)
                    : (n.isVisible = !0),
              ...
              i.setRootVisibility(i.ampdoc.isVisible() ? 1 : 0),
                i.unsubscribe(
                  i.ampdoc.onVisibilityChanged(function () {
          ...
          return (
            (r.dispose = function () {
              t.prototype.dispose.call(this),
                this.Gg && (this.Gg.disconnect(), (this.Gg = null));
            }),
            ...
            (r.getRootLayoutBox = function () {
              ...
              return this.eo.getLayoutRect(n);
            }),
                ...
                function () {
                  ...
                  if (e) {
                    ...
                    -1 != u && e.listeners.splice(u, 1),
                      0 == e.listeners.length &&
                        (i.Gg.unobserve(t), delete i.oAt[r]);
                  }
                }
              );
            }),
            ...
            (r.aAt = function () {
              if (!this.Gg) {
                ...
                this.Gg = new t.IntersectionObserver(this.hAt.bind(this), {
                  threshold: xr,
                });
              }
              return this.Gg;
            ...
            (r.hAt = function (t) {
              ...
              t.forEach(function (t) {
                ...
                (r =
                  ...
                  n.cAt(t.target, t.intersectionRatio, i, r);
              });
            }),
        ...
        Gr = (function (t) {
          ...
          function i(t, i) {
            var r;
            return (
              ((r = n.call(this, t, t.ampdoc)).embed = i),
              (r.sAt = r.parent.isBackgrounded()),
              r.unsubscribe(
                r.parent.observe(i.host, r.setRootVisibility.bind(f(r)))
              ),
              r
            );
          }
          ...
          return (
            ...
            (r.getElementVisibility = function (t) {
              return 0 == this.getRootVisibility()
                ? 0
                : this.parent.getElementVisibility(t);
            }),
            (r.getElementIntersectionRect = function (t) {
              return 0 == this.getRootVisibility()
                ? null
                : this.parent.getElementIntersectionRect(t);
            }),
            i
          );
        })(Vr),
      ...
      var Wr = "amp-analytics/analytics-root",
        ...
        Yr = (function () {
          ...
          return (
            (n.dispose = function () {
              for (var t in this.wEt) this.wEt[t].dispose(), delete this.wEt[t];
            ...
            (n.getTracker = function (t, n) {
              var i = this.wEt[t];
              return i || ((i = new n(this)), (this.wEt[t] = i)), i;
            }),
            (n.getTrackerOptional = function (t) {
              return this.wEt[t] || null;
            }),
            ...
            (n.vAt = function (t) {
              ...
              return this.ampdoc.whenReady().then(function () {
                for (var r = [], e = 0; e < t.length; e++) {
                  ...
                  st(
                    (s = i ? n.dAt(s, o) : s).length,
                    'Element "'.concat(o, '" not found')
                  ),
                    (r = r.concat(s));
                }
            ...
            (n.getElements = function (t, n, i) {
              ...
              return d(n)
                ? (st(
                  ...
                  this.vAt(n, r))
                : this.getElement(t, n, i).then(function (t) {
                    return [t];
                  });
            }),
            (n.mAt = function (t, n) {
              for (var i = 0; i < t.length; i++)
                st(
                  t[i].classList.contains("i-amphtml-element"),
            ...
            (n.createSelectiveListener = function (t, n, i) {
              ...
              return function (u) {
                if (":host" != i)
                  for (
                    var s = r.getRootElement(),
                      o = "*" == i,
                      a = ":root" == i,
                      h = u.target;
                    h && r.contains(h) && ("scope" != e || a || n.contains(h));
                  ...
                  return i
                    ...
                    .then(function () {
                      var t = (function (t) {
                        ...
                        .filter(function (t) {
                          return !(
                            (n && !t.prerenderAllowed()) ||
                            Br.includes(t.element.tagName)
                          );
                        })
                        .map(function (t) {
                          return t.element;
      ...
      var Xr = "__AMP_AN_ROOT",
        Zr = (function () {
          function t(t) {
            (this.ampdoc = t), (this.ge = this.pAt(t.getRootNode()));
          }
          var n = t.prototype;
          return (
            (n.dispose = function () {
            ...
            (n.pAt = function (t) {
              var n = St(t),
                i = vt(t),
                r = i && kn(i);
              return n == this.ampdoc && !r && this.ge
                ? this.ge
                : this.bAt(r || n, function () {
        ...
        te = (function () {
          function t(t, n, i, r) {
            (this.Ji = t),
              ...
              (this.EAt = {}),
              (this.lR = Pt(this.ql)),
              (this.v5 = ct(t, "form-submit-service")),
              (this.gAt = null),
              (this.cA = gi(this.Ji)),
              (this.yAt = null);
          }
          ...
          return (
            (n.init = function () {
              var t = this;
              if (!A(this.nk)) return e();
              (this.yAt = gn(this.Ji.win)), (this.nk = this.AAt(this.nk));
              var n = Object.keys(this.nk).map(function (n) {
                var i = t.nk[n].ids,
                  r = Object.keys(i),
                  e = r.map(function (n) {
                    var r = new fi(t.PV, void 0, !0);
                    return t.SAt(i[n], r);
                  });
              ...
              if (n.length) {
                var i = at(this.Ji, "navigation");
                i.registerAnchorMutator(function (n, i) {
                  n.href && "click" === i.type && (n.href = t.wAt(n.href));
                }, 2),
            ...
            (n.AAt = function (t) {
              var n = {},
                i = { enabled: this.NAt() && this.IAt() },
                r = Object.keys(t).filter(function (n) {
                  var r = t[n],
                    e = A(r);
                  return e || (i[n] = r), e;
                }),
                e = jn.getLocation(this.Ji.win),
                u = this.lR.isProxyOrigin(e);
              return (
            ...
            (n.SAt = function (t, n) {
              var i = this,
                r = this.cA.getMacros(this.ql);
              return this.cA.expandTemplate(t, n, this.ql).then(function (t) {
                return _t(i.ql).expandUrlAsync(t, r);
              });
            }),
            (n.NAt = function () {
              return (
                "googleanalytics" === this.aN &&
                "googleanalytics" ===
                  this.Ji.getMetaByName("amp-google-client-id-api") &&
                this.Ji.registerSingleton(2)
              );
            }),
            (n.IAt = function () {
              var t = ot(this.Ji.win, "platform");
              return t.isSafari() && t.getMajorVersion() >= 12;
            }),
            (n.wAt = function (t) {
              var n = this.nk;
              for (var i in n) this.EAt[i] && (t = this._At(t, i, n[i]));
              return t;
            }),
            (n._At = function (t, n, i) {
              var r = this.lR.parse(t);
              if (this.RAt(r, n, i) && this.PAt(r)) {
                var e = Gn("1", this.EAt[n]);
                if (e) {
                  var u = {};
                  return (
                    (u[n] = e),
            ...
            (n.RAt = function (t, n, i) {
              var r = i.destinationDomains,
                e = t.hostname,
                u = jn.getHostname(this.Ji.win),
                s = i.sameDomainEnabled;
              if (!Boolean(s) && u === e) return !1;
              if (r && !Array.isArray(r))
                return (
                  it().warn(Qr, "%s destinationDomains must be an array.", n),
                  !1
                );
              if (r) return this.CAt(r, e);
              var o = at(this.Ji, "documentInfo").get(),
                a = o.canonicalUrl,
                h = o.sourceUrl,
                c = ne(this.lR.parse(a).hostname, e);
              if (this.yAt) {
                var f = [this.yAt, "*" + this.yAt];
                return this.CAt(f, e) || c;
              }
              return ne(this.lR.parse(h).hostname, e) || c;
            }),
            (n.PAt = function (t) {
            ...
            (n.LAt = function (t, n, i) {
              var r = { type: "hidden", name: n, value: i },
      ...
      var ee = {
        ...
        se = (function () {
          ...
          var n = t.prototype;
          return (
            (n.generateRequest = function (t, n) {
              var i =
      ...
      var he = (function () {
        function t(t, n, i, r, e) {
          (this.ql = t),
            (this.Ji = t.getAmpDoc()),
            (this.win = this.Ji.win),
            (this.kAt = n.origin),
            (this.baseUrl = ut(n.baseUrl)),
            (this.UAt = n.batchInterval),
            (this.xAt = Number(n.reportWindow) || null),
            (this.jAt = null),
            (this.cA = gi(t)),
            (this.HC = _t(t)),
            (this.lR = Pt(t)),
        ...
        return (
          (n.send = function (t, n, i) {
            ...
            if (this.WAt || r) {
                  ...
                  u && Date.now() < s + 6e4
                    ? (function (t, n) {
                        ...
                        if (
                          ...
                          !(A((i = n).resources)
                            ? i.encoding && i.encoding.entry && i.encoding.delim
                              ? i.encoding.base < 2 || i.encoding.base > 36
                                ? (it().warn(
                                    "ANALYTICS",
                                    "resource timing variables only supports bases between 2 and 36"
                                  ),
                                  0)
                                : null == i.responseAfter ||
                                  "number" == typeof i.responseAfter ||
                                  (it().warn(
                                    "ANALYTICS",
                            ...
                            : (it().warn(
                                "ANALYTICS",
                                'resourceTimingSpec missing "resources" field'
                              ),
                              0))
                        )
                          return (n.done = !0), Promise.resolve("");
                        var e = (function (t) {
                        ...
                        var u,
                          s = n.responseAfter || 0;
                        return (
                          (n.responseAfter = Math.max(s, r.performance.now())),
                                    ...
                                    s = function (t) {
                                      var n =
                                        ...
                                        void 0 !== arguments[1]
                                          ? arguments[1]
                                          : 0;
                                      return Math.round(t - n).toString(
                                        e.base || 10
                                      );
                                    },
                                    o = (function (t, n) {
                    ...
                    : Promise.resolve(""))),
                this.HAt ||
                  (i.freezeVar("extraUrlParams"),
                  (this.HAt = this.KAt(this.baseUrl, i, o))),
                !this.FAt && this.kAt)
              ) {
              ...
              var h = Wt(Wt({}, t), n.extraUrlParams),
                c = this.win.Date.now(),
                f = ce(this.cA, this.HC, h, i, o, this.ql, this.we).then(
                  function (t) {
                    return { trigger: n.on, timestamp: c, extraUrlParams: t };
                  }
                );
              this.VAt.push(f), this.he(r || !this.UAt);
            }
          }),
          (n.dispose = function () {
            this.Ur(),
              this.GAt && (this.win.clearTimeout(this.GAt), (this.GAt = null)),
              this.BAt && (this.win.clearTimeout(this.BAt), (this.BAt = null));
          }),
          (n.KAt = function (t, n, i) {
            var r = this;
            return this.cA
              .expandTemplate(t, n, this.ql, i, this.we)
              .then(function (t) {
                return r.HC.expandUrlAsync(t, i, r.we).catch(function (n) {
                  return st(
                    !1,
                    'Could not expand URL "'.concat(t, '": ').concat(n.message)
                  );
                });
              });
          }),
                ...
                0 !== r.length &&
                  (e.iframePing
                    ? (st(
                      ...
                      t.EC.sendRequestUsingIframe(i, r[0]))
                    : t.EC.sendRequest(i, r, !!t.UAt));
              });
          }),
          (n.Ur = function () {
            (this.g$ = 0),
          ...
          (n.zAt = function () {
            if (this.UAt) {
              this.UAt = d(this.UAt) ? this.UAt : [this.UAt];
              for (var t = 0; t < this.UAt.length; t++) {
                var n = this.UAt[t];
                st(N(n), "Invalid batchInterval value: %s", this.UAt),
                  st(
                    (n = 1e3 * Number(n)) >= 200,
                    "Invalid batchInterval value: %s, interval value must be greater than %s ms.",
                    this.UAt,
                    200
                  ),
                  (this.UAt[t] = n);
          ...
          (n.YAt = function () {
            var t = this;
            this.xAt &&
              (this.BAt = this.win.setTimeout(function () {
                t.he(!0),
                  (t.WAt = !1),
                  t.GAt && (t.win.clearTimeout(t.GAt), (t.GAt = null));
              }, 1e3 * this.xAt));
          }),
          (n.ZAt = function () {
            var t = this;
            ut(null != this.jAt);
            var n =
              this.jAt < this.UAt.length
                ? this.UAt[this.jAt++]
                : this.UAt[this.UAt.length - 1];
            this.GAt = this.win.setTimeout(function () {
              t.he(!0), t.ZAt();
            }, n);
          }),
          (n.XAt = function (t, n) {
            return n ? this.lR.parse(n).origin + t : t;
          }),
          t
        );
      })();
      function ce(t, n, i, r, e, u, s) {
        for (
          var o = {},
            a = [],
            h = new fi(r.vars, r.iterations, !0),
            c = function i(r, o, c) {
              var f = r[o];
              if ("string" == typeof f) {
                c[o] = void 0;
                var l = t
                  .expandTemplate(f, h, u)
                  .then(function (t) {
      ...
      var fe = (function () {
          ...
          return (
              ...
              ut(t && t.creativeId && t.message),
                ...
                this.queueSize() >= 100 &&
                  (et().warn(
                    ...
                    "Exceeded maximum size of queue for: " + t.creativeId
                  ),
                  this.QAt.shift()),
                this.tSt();
            }),
            (n.tSt = function () {
              this.isReady() &&
                this.queueSize() &&
                (this.Vpt.send("iframe-transport-events", { events: this.QAt }),
                (this.QAt = []));
            }),
            t
          );
        ...
        ve = (function () {
          ...
          return (
            (n.detach = function () {
              t.markCrossDomainIframeAsDone(this.nSt.document, this.aN);
            }),
            (n.processCrossDomainIframe = function () {
              var n;
              t.hasCrossDomainIframe(this.aN)
                ? ++(n = t.getFrameData(this.aN)).usageCount
                : ((n = this.createCrossDomainIframe()),
                  this.nSt.document.body.appendChild(n.frame),
                  this.Cv()),
                ut(n);
            }),
            (n.createCrossDomainIframe = function () {
              var n = t.uSt(),
                ...
                r = x(this.nSt.document, "iframe", {
                  sandbox: "allow-scripts allow-same-origin",
                  name: i,
                  "data-amp-3p-sentinel": n,
                });
              (r.sentinel = n), _n(r, !1), (r.src = this.rSt);
              var e = { frame: r, usageCount: 1, queue: new fe(this.nSt, r) };
              return (t.sSt[this.aN] = e), e;
            }),
            (n.Cv = function () {
              var n,
                i = this;
              (n = this.nSt).PerformanceObserver &&
                n.TaskAttributionTiming &&
                "containerName" in n.TaskAttributionTiming.prototype &&
                ((t.oSt[this.aN] = new this.nSt.PerformanceObserver(function (
                  t
                ) {
                  t &&
                    t.getEntries().forEach(function (t) {
                      t &&
                        ...
                        "cross-origin-descendant" == t.name &&
                        t.attribution &&
                        t.attribution.forEach(function (t) {
                          i.rSt == t.containerSrc &&
                            ++i.eSt % 5 == 0 &&
                            it().error(
                              "amp-analytics/iframe-transport",
                              'Long Task: Vendor: "'.concat(i.aN, '"')
                            );
                        });
                    });
                })),
                t.oSt[this.aN].observe({ entryTypes: ["longtask"] }));
            }),
            (t.markCrossDomainIframeAsDone = function (n, i) {
              var r = t.getFrameData(i);
              ut(r && r.frame && r.usageCount),
                --r.usageCount ||
                  (n.body.removeChild(r.frame),
                  delete t.sSt[i],
                  t.oSt[i] && (t.oSt[i].disconnect(), (t.oSt[i] = null)));
            }),
            ...
            (n.sendRequest = function (n) {
              var i = t.getFrameData(this.aN);
              ut(i),
                ut(i.queue),
                i.queue.enqueue({ creativeId: this.iSt, message: n });
            }),
      ...
      function me(t, n) {
        ...
        if (null != r)
          if (de(t.document)) {
            var a = pe(t, (o = 6), e);
            (r = a(r)), (s.attributionSrc = r);
          } else o = 5;
        var h = pe(t, o, e);
        return (n = h(n)), (s.src = n), s;
      }
      function pe(t, n, i) {
        var r = {
      ...
      (ve.sSt = {}), (ve.aSt = 0), (ve.oSt = {});
      var Te,
        be,
        Ee = "amp-analytics/transport",
        ge = (function () {
          function t(t) {
            var n =
              arguments.length > 1 && void 0 !== arguments[1]
            ...
            (this.Ji = t),
              (this.t = t.win),
              (this.Xt = n),
              (this.ue = this.Xt.referrerPolicy),
              "no-referrer" === this.ue &&
                ((this.Xt.beacon = !1), (this.Xt.xhrpost = !1)),
              (this.hSt = !!this.Xt.useBody),
              (this.cSt = null),
              (this.fSt = "inabox" == K(this.t).runtime),
              (this.lSt = this.Xt.attributionsrc);
          }
          var n = t.prototype;
          return (
            (n.sendRequest = function (n, i, r) {
              if (n && 0 !== i.length) {
                var e,
                  u,
                  s = this.vSt(),
                  o =
                    ((e = function (t) {
                      var e = r
                        ? s.generateBatchRequest(n, i, t)
                        : s.generateRequest(n, i[0], t);
                      return (
                        e.url.startsWith("amp-script:") ||
                          (ln(e.url, "amp-analytics request"),
                          (function (t) {
                            st(
                              !("__amp_source_origin" in $(on(t).search)),
                ...
                if (this.Xt.iframe)
                  return this.cSt
                    ? void this.cSt.sendRequest(o(!1).url)
                    : void et().error(
                        Ee,
                        "iframe transport was inadvertently deleted"
                      );
                if (this.Xt["amp-script"])
                  t.forwardRequestToAmpScript(this.Ji, {
                    url: n,
                    payload: o(!0).payload,
                  });
                else if (
                  !(
                    (this.Xt.beacon &&
                      t.sendRequestUsingBeacon(this.t, o(this.hSt))) ||
                    (this.Xt.xhrpost &&
                      t.sendRequestUsingXhr(this.t, o(this.hSt)))
                  )
                ) {
                  var a = this.Xt.image;
                  if (a) {
                    var h = "object" == c(a) && a.suppressWarnings;
                    t.sendRequestUsingImage(
                      this.t,
                      o(!1),
                      h,
                      this.ue,
                  ...
                  } else it().warn(Ee, "Failed to send request", n, this.Xt);
                }
              } else et().info(Ee, "Empty request not sent: ", n);
            }),
            (n.maybeInitIframeTransport = function (t) {
              if (this.Xt.iframe && !this.cSt) {
                var n = lt(P(t)),
                  i = t.getAttribute("type"),
                  r = this.fSt
                    ? "1"
                    : it().assertString(
                        ...
                        "No friendly amp-ad ancestor element was found for amp-analytics tag with iframe transport."
                      );
                this.cSt = new ve(n, i, this.Xt, r);
              }
            }),
            (n.deleteIframeTransport = function () {
              this.cSt && (this.cSt.detach(), (this.cSt = null));
            }),
            (n.sendRequestUsingIframe = function (t, n) {
              ...
              if (r) {
                ln(r, "amp-analytics request"),
                  st(
                    on(r).origin != on(this.t.location.href).origin,
                    "Origin of iframe request must not be equal to the document origin. See https://github.com/ampproject/amphtml/blob/main/docs/spec/amp-iframe-origin-policy.md for details."
                  );
              ...
              } else it().error(Ee, "Request not sent. Contents empty.");
            }),
            (n.vSt = function () {
              return oe.default;
            }),
                ...
                (function (t) {
                  ...
                  return r && t.__AMP_MEDIA_LOAD_FAILURE_SRC === t.currentSrc
                    ...
                    : new Promise(function (e, u) {
                        if (
                          ((n = r
                            ? Ut(t, "loadedmetadata", e, { capture: !0 })
                            : Ut(t, "load", e)),
                          t.tagName)
                        ) {
                          var s = t;
            ...
            (t.sendRequestUsingBeacon = function (t, n) {
              ...
              return r && et().fine(Ee, "Sent beacon request", n), r;
            }),
        ...
        Se = (function (t) {
          ...
          function i(t) {
            ...
            return (
              ...
              (i.ESt = null),
              (i.EC = null),
              (i.aN = i.element.getAttribute("type")),
              (i.fSt = "inabox" == K(i.win).runtime),
              (i.gSt = null),
              (i.ySt = null),
              (i.ASt = null),
              i
          ...
          return (
            ...
            (r.buildCallback = function () {
              ...
              (this.UTt = this.element.hasAttribute("sandbox")),
                ...
                (this.mSt = this.element.getAttribute(
                  "data-consent-notification-id"
                )),
                null != this.mSt &&
                  (this.dSt = ((t = this.element),
                  (function (t, n, i, r) {
                    return yt(t, "userNotificationManager", i, void 0).then(
                      function (t) {
                        return (function (t, n, i) {
                          return st(
                            t,
                ...
                "immediate" == this.element.getAttribute("trigger") &&
                  this.SSt();
            }),
            ...
            (r.detachedCallback = function () {
              for (var t in (this.TSt &&
                (this.TSt.dispose(), (this.TSt = null)),
              this.gSt && (this.gSt.dispose(), (this.gSt = null)),
              this.bV))
                this.bV[t].dispose(), delete this.bV[t];
            }),
            (r.resumeCallback = function () {
              var t = this;
              this.ESt &&
                this.ESt.then(function () {
                  t.EC.maybeInitIframeTransport(t.element);
                });
            }),
            ...
            (r.SSt = function () {
              ...
              return (
                (this.ESt = n
                  ...
                  .then(function () {
                    return Promise.all([
                      ((t = n), ct(t, "amp-analytics-instrumentation")),
                      yi(n),
                    ]);
                    var t;
                  })
                  .then(function (n) {
                    ...
                    return t.fSt ? r() : Li(t.element, r, 20), i.promise;
                  })
                  .then(function (n) {
                    return (t.nk = n), new qi(t.win, t.element, t.nk).write();
                  })
                  .then(function () {
                    t.EC = new ge(t.getAmpDoc(), t.nk.transport || {});
                  })
                  .then(this.wSt.bind(this))
                  .then(this.OSt.bind(this))
                  .then(this.NSt.bind(this))),
                this.ESt.then(function () {
                  t.collapse();
                }),
                this.ESt
            ...
            (r.ISt = function () {
              return (
                !!this.fSt ||
                (null == this.ASt && (this.ASt = Un(this.element)), this.ASt)
              );
            }),
            (r.wSt = function () {
              var t = this;
              return this.nk.triggers &&
                Object.values(this.nk.triggers).some(function (t) {
                  var n;
                  return null == t || null === (n = t.session) || void 0 === n
                    ? void 0
                    : n.persistEvent;
                }) &&
                this.aN
                ? si(this.getAmpDoc()).then(function (n) {
                    t.ySt = n;
                  })
                : e();
            }),
            (r.OSt = function () {
              ...
              if (this._St()) {
                var n = this.qn();
                return (
                  it().fine(n, "User has opted out. No hits will be sent."), e()
                );
              }
              if ((this.RSt(), !this.nk.triggers)) {
                var i = this.qn();
                return (
                  this.user().warn(
                    i,
              ...
              this.PSt(
                this.nk.extraUrlParams,
                this.nk.extraUrlParamsReplaceMap
              ),
                (this.TSt = this.pSt.createAnalyticsGroup(this.element)),
                this.EC.maybeInitIframeTransport(this.element);
              var r = [];
              for (var u in this.nk.triggers)
                !w(this.nk.triggers, u) ||
                  (function () {
                    var n = t.nk.triggers[u],
                      i = t.CSt({}, n, void 0, !0),
                      e = t.qn();
                    if (!n)
                      return (
                        t.user().error(e, "Trigger should be an object: ", u),
                        "continue"
                      );
                    var s,
                      o = n.request || (n.parentPostMessage && t.ISt());
                    if (!n.on || !o) {
                      var a = t.ISt() ? '/"parentPostMessage"' : "";
                      return (
                        t
                          .user()
                          .error(
                      ...
                      if (
                        ...
                        return (
                          t
                            ...
                            .error(
                              e,
                              h + " is not supported for amp-analytics in scope"
                            ),
                          "continue"
                        );
                    }
                    t.PSt(n.extraUrlParams, t.nk.extraUrlParamsReplaceMap),
                      r.push(
                        t.MSt(n).then(function (r) {
                          if (r) {
                            if (t.UTt) {
                              if (!t.element.parentElement) return;
                              return (
                                (n.selector = t.element.parentElement.tagName),
                                (n.selectionMethod = "closest"),
                                t.DSt(n)
                              );
                            }
                            return n.selector && !d(n.selector)
                              ? t.cA
                                  .expandTemplate(n.selector, i, t.element)
                                  .then(function (i) {
                                    return (n.selector = i), t.DSt(n);
                                  })
                              : t.DSt(n);
                          }
                        })
            ...
            (r.DSt = function (t) {
              if (!this.TSt) return e();
              try {
                return this.TSt.addTrigger(t, this.mg.bind(this, t));
              } catch (n) {
                return (
                  G(this.qn(), 'Failed to process trigger "' + t.on + '"', n),
                  e()
                );
              }
            }),
            ...
            (r._St = function () {
              var t = this.nk.optoutElementId;
              if (t && this.win.document.getElementById(t)) return !0;
              if (!this.nk.optout) return !1;
              for (
                var n = this.nk.optout.split("."), i = this.win, r = 0;
                r < n.length;
                r++
              ) {
                if (!i) return !1;
            ...
            (r.RSt = function () {
              ...
              if (this.nk.requests) {
                if (this.nk.requests) {
                  for (var n in this.nk.requests)
                    w(this.nk.requests, n) &&
                      (this.nk.requests[n].baseUrl ||
                        (this.user().error(ye, "request must have a baseUrl"),
                        delete this.nk.requests[n]));
                  for (var i in this.nk.requests)
                    this.nk.requests[i].baseUrl = T(
                      this.nk.requests[i].baseUrl,
                      function (n) {
                        var i = t.nk.requests[n];
                        return (i && i.baseUrl) || "${" + n + "}";
                      },
                      5
                    );
                  var r = {};
                  for (var e in this.nk.requests)
                    if (w(this.nk.requests, e)) {
                      var u = this.nk.requests[e];
                      r[e] = new he(
                        this.element,
                        u,
                        Nt(this.win),
            ...
            (r.NSt = function () {
              ...
              this.fSt ? n() : Li(this.element, n, 10);
            }),
            (r.mg = function (t, n) {
              var i, r;
              null === (i = t.session) ||
                ...
                null === (r = this.ySt) ||
                void 0 === r ||
                r.updateEvent(this.aN);
              for (
                var e = d(t.request) ? t.request : [t.request], u = 0;
                u < e.length;
                u++
              ) {
                var s = e[u];
            ...
            (r.LSt = function (t, n, i) {
              ...
              var u = this.bV[t],
                s = this.ISt() && n.parentPostMessage;
              if (null != t && !u) {
                var o = this.qn();
                if (
                  (this.user().error(
              ...
              this.kSt(n, i).then(function (t) {
                var e =
                  r.element.ownerDocument &&
                  r.element.ownerDocument.defaultView;
                t &&
                  e &&
                  (r.USt(u, n, i),
                  n.parentPostMessage && r.ISt() && H(r.win) && r.xSt(n, i));
              });
            }),
            (r.USt = function (t, n, i) {
              if (t) {
                this.nk.vars.requestCount++;
                var r = this.CSt(i, n);
                t.send(this.nk.extraUrlParams, n, r);
              }
            }),
            (r.xSt = function (t, n) {
              var i = this,
            ...
            (r.MSt = function (t) {
              ...
              if (!e)
                return (
                  this.user().error(r, "Invalid sampleOn value."),
                  Promise.resolve(!0)
                );
              ...
              if (s >= 0 && s <= 100) {
                ...
                return this.fSt ? a() : Li(this.element, a, 10), o.promise;
              }
              return (
                it().error(r, "Invalid threshold for sampling."),
                Promise.resolve(!0)
              );
            }),
            (r.kSt = function (t, n) {
              var i = this.CSt(n, t),
                r = this.jSt(this.nk.enabled, i),
                e = this.jSt(t.enabled, i);
            ...
            (r.SAt = function (t, n) {
              var i = this;
              return this.cA
                .expandTemplate(t, n, this.element)
                .then(function (t) {
                  return _t(i.element).expandUrlAsync(
                    t,
                    i.cA.getMacros(i.element)
                  );
                });
            }),
            (r.qn = function () {
